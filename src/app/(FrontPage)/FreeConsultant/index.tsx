            ...
            <div className="container">
                <div className="grid md:grid-cols-[3fr_4fr] items-center">
                    <div className="text-center">
                        <Image src={BabySleeping} alt={"Shape Top"} className='inline-block w-[205px] max-w-[35%] mb-4' />
                        <h2 className='text-4xl lg:text-5xl font-quicksand font-bold text-dark mb-1'>Start a Free Consult</h2>
                        <p className='text-xl mb-6'>Conquer nighttime sleep, solve early rising, land naps, and deal with regressions.</p>
